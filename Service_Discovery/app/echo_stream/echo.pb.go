...
var file_echo_proto_rawDesc = []byte{
	...
	0x6f, 0x2e, 0x45, 0x63, 0x68, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x38, 0x0a,
	...
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3d, 0x0a, 0x11, 0x53, 0x61, 0x79, 0x48, 0x65,
	0x6c, 0x6c, 0x6f, 0x42, 0x69, 0x64, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x11, 0x2e, 0x65,
	...
	0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x16, 0x5a, 0x14, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
	0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x65, 0x63, 0x68, 0x6f, 0x62, 0x06,
...
var file_echo_proto_depIdxs = []int32{
	...
	0, // 2: echo.EchoServer.SayHelloBidStream:input_type -> echo.EchoRequest
	1, // 3: echo.EchoServer.SayHello:output_type -> echo.EchoReply
	1, // 4: echo.EchoServer.SayHelloStream:output_type -> echo.EchoReply
	1, // 5: echo.EchoServer.SayHelloBidStream:output_type -> echo.EchoReply
